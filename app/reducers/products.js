...
const ids = (state = new Map(), action) => {
  ...
  case 'UPDATE_SORT':
    return new Map();
  case 'FETCH_PRODUCTS_REQUEST':  //initializing fetch request 
    ...
    return state;
  case 'FETCH_PRODUCTS_SUCCESS':  //success 
  ...
  case 'END_OF_CATALOGUE':   //end of amazing catalogue MUST SCROLL TO BOTTOM IN ORDER TO INITIATE
    return toMap([
      ...action.buffer.values(),
    ]);
  default:
